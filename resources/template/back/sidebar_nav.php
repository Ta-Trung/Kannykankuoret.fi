<nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a href="index.php?orders" class="nav-link active text-dark">
                <svg class="bi text-dark" width="24" height="24">
                  <use xlink:href="node_modules/bootstrap-icons/bootstrap-icons.svg#file-earmark"/>
                </svg> Orders <span class="sr-only">(current)</span>
              </a>
            </li>
            ...
            <li class="nav-item">
              <a href="index.php?users" class="nav-link active text-dark">
                <svg class="bi text-dark" width="24" height="24">
                  <use xlink:href="node_modules/bootstrap-icons/bootstrap-icons.svg#wallet2"/>
          ...
          <h6 class="sidebar-heading d-flex justify-content-between align-items-center px-3 mt-4 mb-1 text-muted">
            ...
            <a href="#" class="d-flex align-items-center text-muted">
              <svg class="bi text-dark" width="24" height="24">
                <use xlink:href="node_modules/bootstrap-icons/bootstrap-icons.svg#plus-circle"/>
              </svg>
            </a>
          </h6>
          ...
          <ul class="nav flex-column mb-2">
            <li class="nav-item">
              <a href="#" class="nav-link text-dark">
                <svg class="bi text-dark" width="24" height="24">
                  <use xlink:href="node_modules/bootstrap-icons/bootstrap-icons.svg#file-earmark-text"/>
                </svg> Current month
              </a>
            </li>
            <li class="nav-item">
